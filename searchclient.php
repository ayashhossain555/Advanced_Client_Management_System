                    ...
                    <tbody>
                        <?php
                         ...
                         if(isset($_GET['search'])){
                          ...
                          $filterdata="SELECT * FROM CLIENTS WHERE CONCAT(ID, name, email,password, mobile) LIKE '%$filtervalue%'";
                          ...
                          if(mysqli_num_rows($run)>0){
                            foreach($run as $i){
                              ...
                              <tr>
                                  ...
                                  <td> <?= $i['linkdin']; ?></td>
                                  <td> <?= $i['othersocial']; ?></td>
                                  <td><a href="editclient.php?ID=<?= $i["ID"]; ?>" class="btn btn-primary">Edit</a> 
                                  </td>
                                  <td>
